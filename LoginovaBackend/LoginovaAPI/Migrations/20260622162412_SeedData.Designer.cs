...
namespace LoginovaAPI.Migrations
{
    ...
    [Migration("20260622162412_SeedData")]
            ...
            modelBuilder.Entity("LoginovaAPI.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2026, 6, 22, 16, 24, 11, 742, DateTimeKind.Utc).AddTicks(1520),
                            Nombre = "Administrador",
                            Password = "pbkdf2$100000$K3mHljH8+IwT5X3Yzs6jZA==$Zk0KpLcM8F9cBVqWVqRx0cWX297/M2TNGgfxj3LX374=",
                            RoleId = 1
                        });
                });
