...
namespace LoginovaAPI.Migrations
{
    ...
    [Migration("20260703203616_AddPermissionsAndIncome")]
    partial class AddPermissionsAndIncome
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LoginovaAPI.Models.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2026, 7, 3, 20, 36, 15, 876, DateTimeKind.Utc).AddTicks(5251),
                            Nombre = "Administrador",
                            Password = "pbkdf2$100000$gTjzWiB+nhhcbAVqygYFZQ==$LImtHYh4ROglOXZtsMx80FP6/3LyE9ybQFXBGvJhcvo=",
                            PermisosJson = "[]",
                            RoleId = 1
                        });
                });
